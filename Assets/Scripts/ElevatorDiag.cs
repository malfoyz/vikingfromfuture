...
public class ElevatorDiag : MonoBehaviour
{
    ...
    void Start()
    {
        point.transform.position = new Vector3(transform.position.x + 4.6f, transform.position.y + 13f, transform.position.z);    // точке присваиваем позицию = позиция руки + 1 по ОY
    }
    void Update()
    {
        if (isWait == false)
        ...
        if (transform.position == point.position)                                                           // если позиция руки дошла до позиции точки
        {
            ...
            {
                point.transform.position = new Vector3(transform.position.x + 4.6f, transform.position.y + 13f, transform.position.z);
